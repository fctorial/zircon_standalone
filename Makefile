...
out/linker: gen_linker.js ${FOUT}/gen/zircon/vdso/zx.fidl.json
	node gen_linker.js
	touch out/linker
...
out/custom.zbi: make.sh out/init custom_bootfs.fini ${FOUT}/kernel_x64/kernel.zbi ${FOUT}/multiboot.bin Makefile
	./make.sh
